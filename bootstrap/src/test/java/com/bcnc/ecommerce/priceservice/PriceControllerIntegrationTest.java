...
public class PriceControllerIntegrationTest
{
    ...
    private static final String AUTH_HEADER = "Bearer 12345678";
    ...
    @Nested
    @DisplayName("Seguridad en endpoint /prices/applicable")
    class SecurityTests
    {
        @Test
        @DisplayName("Debe devolver 401 con mensaje JSON si no se envía token")
        void testUnauthorizedWithoutTokenWithMessage() throws Exception
        {
            mockMvc.perform(get(PRICE_CALCULATION_ENDPOINT)
                            .param(PARAM_DATE, "2020-06-14T10:00:00")
                            .param(PARAM_PRODUCT, "35455")
                    ...
                    .andExpect(jsonPath("$.message").value("Invalid or missing Bearer token"));
        }

        @Test
        @DisplayName("Debe devolver 401 si el token es inválido")
        void testUnauthorizedWithInvalidToken() throws Exception
        {
            mockMvc.perform(get(PRICE_CALCULATION_ENDPOINT)
                            .param(PARAM_DATE, "2020-06-14T10:00:00")
                            .param(PARAM_PRODUCT, "35455")
